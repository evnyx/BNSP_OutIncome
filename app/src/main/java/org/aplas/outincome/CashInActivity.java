...
public class CashInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BtnBack = (Button) findViewById(R.id.btnCashInBack);
        Calender = (ImageView) findViewById(R.id.imgCalender);
        BtnSave = (Button) findViewById(R.id.btnCashInSave);
        CalenderText = (EditText) findViewById(R.id.txDateCashIn);
        AmountText = (EditText) findViewById(R.id.txAmountCashIn);
        DescText = (EditText) findViewById(R.id.txDescCashIn);
        ...
        BtnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CashInActivity.this, BerandaActivity.class);
            ...
            public void onClick(View view) {
                try {
                    ...
                    if (CalenderText.getText().toString().isEmpty() || AmountText.getText().toString().isEmpty() || DescText.getText().toString().isEmpty()){
                        Toast.makeText(CashInActivity.this, "Check Your Form Again", Toast.LENGTH_SHORT).show();
                    }else{
                        ...
                        if(dbHelper.createNote(note)){
                            Toast.makeText(CashInActivity.this, "New Note Added", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(CashInActivity.this, BerandaActivity.class);
                            intent.putExtra("account", account);
                            startActivity(intent);
                        }else {
                            Toast.makeText(CashInActivity.this, "Failed Make a New Note", Toast.LENGTH_SHORT).show();
                        }
                    }
                }catch (Exception e){
                    Toast.makeText(CashInActivity.this, "Failed Make a New Note!", Toast.LENGTH_SHORT).show();
